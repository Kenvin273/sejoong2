...
<div class="row">
	<div class="col-12 grid-margin">
		<div class="card">
			<div class="card-body">
				<h5 class="card-title mb-4">Danh sách sự kiện</h5>
						...
						<div class="ticket-details col-md-9">
							<div class="d-flex">
								...
								<p class="text-primary mr-1 mb-0">
									[<%
									 String timeStamp = new java.text.SimpleDateFormat("yyyy-MM-dd").format(Calendar.getInstance().getTime());
							...
							<div class="btn-group dropdown">
								...
								<div class="dropdown-menu">
									<a class="dropdown-item"
										href="${pageContext.request.contextPath}/CRUDEvent?id=<%out.print(ev.getEvetnId());%>&type=edit-event">
										<i class="fa fa-reply fa-fw"></i>Sửa bài viết
									</a>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item"
										href="${pageContext.request.contextPath}/CRUDEvent?id=<%out.print(ev.getEvetnId());%>&type=delete-event"
										style="color: red;"> <i
