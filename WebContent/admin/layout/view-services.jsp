...
<%@page import="com.tuvi.dao.ServiceInfo"%>
<div class="row">
	<div class="col-12 grid-margin">
		<div class="card">
			<div class="card-body">
				<h5 class="card-title mb-4">Danh sách dịch vụ</h5>
				<form action="">
					<button type="submit" class="btn btn-success mr-2" type="submit" value="add-services" name ="type"
						formaction="${pageContext.request.contextPath}/Layouts">Thêm dịch vụ</button>
				...
				<div class="fluid-container">
					...
					<%
						try {
							ArrayList<ServiceInfo> list = (ArrayList<ServiceInfo>) DBUtil
									.queryService(DBConnection.getMySQLConnection());
							if (list.size() > 0) {
								int i = 1;
								for (ServiceInfo ev : list) {
									try {
					%>
							...
							<div class="btn-group dropdown">
								...
								<div class="dropdown-menu">
									<a class="dropdown-item"
										href="${pageContext.request.contextPath}/CRUDService?id=<%out.print(ev.getServiceId());%>&type=edit-service">
										<i class="fa fa-reply fa-fw"></i>Sửa bài viết
									</a>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item"
										href="${pageContext.request.contextPath}/CRUDService?id=<%out.print(ev.getServiceId());%>&type=delete-service"
										style="color: red;"> <i
