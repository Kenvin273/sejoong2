...
<head>
  ...
  <title>Đăng nhập quản lý Sejoong Việt Nam</title>
  <!-- plugins:css -->
      ...
      <div class="content-wrapper d-flex align-items-center auth auth-bg-1 theme-one">
        <div class="row w-100">
          <div class="col-lg-4 mx-auto">
            ...
            <p class="footer-text text-center">copyright © 2018 Teamwork by <a href="https://join.skype.com/invite/SscaOWUroM2S">VietPDb</a></p>
          </div>
        </div>
      </div>
